/* ========================================
🔥 ELITE V4 ENTER ENGINE (MULTI-SCHOOL)
======================================== */
...
/* ========================================
🔥 DYNAMIC SUBMIT (MULTI-SCHOOL)
======================================== */

async function sendToGoogle(entry) {

const submitURL = await getSchoolSubmitURL();

if (!submitURL) {
throw new Error("No submit URL for this school");
}

console.log("📤 Sending to:", submitURL);
